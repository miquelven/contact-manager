...
const featuresData = [
  {
    ...
    icon: <FilePlus2 className="w-12 h-12 max-sm:w-10 max-sm:h-10" />,
  },
  {
    id: 1,
    title: "Edite",
    ...
    icon: <FilePenLine className="w-12 h-12 max-sm:w-10 max-sm:h-10" />,
  },
  {
    id: 2,
    title: "Baixe",
    description: "Baixe sua lista de contatos para uso offline.",
    icon: <Download className="w-12 h-12 max-sm:w-10 max-sm:h-10" />,
  },
  {
    id: 3,
    title: "Filtre",
    description: "Filtre contatos para encontrar exatamente o que precisa.",
    icon: <Filter className="w-12 h-12 max-sm:w-10 max-sm:h-10" />,
  },
];
