  ...
  return (
    ...
    >
      <Container>
        ...
        <p className="text-lg text-light text-center px-60 text-white/80 mt-5">
        ...
        <ul className="grid grid-cols-4  gap-10 my-28">
          {featuresData.map((feature) => (
            <li key={feature.id}>
              <Card>
                <CardContent className="flex flex-col gap-8 justify-center items-center h-72 rounded-lg hover:bg-black/20">
                  <div className="flex flex-col justify-center items-center gap-10">
                    <h6 className="text-3xl font-semibold">{feature.title}</h6>
